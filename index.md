...
<p id="collaborative_notes">
  <h4>We will use the collaborative document at <a href="{{page.collaborative_notes}}">{{page.collaborative_notes}}</a> for chatting, taking notes, and sharing URLs and bits of code.</h4>
</p>
{% endif %}
